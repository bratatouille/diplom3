...
class Product(models.Model):
    ...
    meta_title = models.CharField('SEO Заголовок', max_length=255, blank=True, default='', help_text='Заголовок для SEO (meta title)')
    meta_description = models.CharField('SEO Описание', max_length=500, blank=True, default='', help_text='Описание для SEO (meta description)')
